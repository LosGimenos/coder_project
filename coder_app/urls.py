...
urlpatterns = [
    ...
    url(r'^(?P<project_id>[0-9]+)/edit_project/coders', views.edit_project_coders, name='edit_project_coders'),
    url(r'^(?P<project_id>[0-9]+)/edit_project/mentions', views.edit_project_mentions, name='edit_project_mentions'),
    url(r'^(?P<project_id>[0-9]+)/edit_project/variables', views.edit_project_variables, name='edit_project_variables'),
